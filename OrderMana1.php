        ...
        <div class="user-mana">
            ...
            <div class="order-mana-right">
                <div class="order-mana__menu">
                    ...
                    <a style="border-bottom: 2px solid rgb(13, 80, 17); color: rgb(24, 116, 30); font-weight: bold" href="Ordermana1.php">Chờ xác nhận</a>
                ...
                <form action="OrderMana.php">
                    ...
                    $rs5 = mysqli_query($connect, "SELECT orders.Id_orders, orders.OrderDate, orders.Status FROM orders WHERE Id_account='$Id_account' and orders.Status=1 order by orders.OrderDate desc");
                    if ($rs5->num_rows > 0) {
                                    ...
                                    <div class="order-mana-con-total">
                                        ...
                                        ?>
                                                <div class="order-mana-con-total-col">
                                                    <a style="background: rgb(180,69,168);background: linear-gradient(90deg, rgba(180,69,168,1) 0%, rgba(187,28,74,1) 50%, rgba(117,8,25,1) 100%);" href="update_order_status.php?id=<?php echo $Id_orders ?>&status=4" onClick="return confirm('Bạn có muốn hủy đơn hàng này không?')"" class="">Hủy</a>
                                                </div>
                                                <div class="order-mana-con-total-col">
