        ...
        <div class="user-mana">
            ...
            <div class="order-mana-right">
                <div class="order-mana__menu">
                    ...
                    <a style="border-bottom: 2px solid rgb(13, 80, 17); color: rgb(24, 116, 30); font-weight: bold"  href="OrderMana4.php">Đã hủy</a>
                </div>
                ...
                <form action="OrderMana.php">
                    ...
                    $rs5 = mysqli_query($connect, "SELECT orders.Id_orders, orders.OrderDate, orders.Status FROM orders WHERE Id_account='$Id_account' and orders.Status=4 order by orders.OrderDate desc");
                    if ($rs5->num_rows > 0) {
