        ...
        <div class="user-mana">
            ...
            <div class="order-mana-right">
                <div class="order-mana__menu">
                    <a style="border-bottom: 2px solid rgb(13, 80, 17); color: rgb(24, 116, 30); font-weight: bold" href="OrderMana.php">Tất cả</a>
                    <a href="Ordermana1.php">Chờ xác nhận</a>
                    <a href="OrderMana2.php">Đang giao hàng</a>
                    <a href="OrderMana3.php">Đã giao hàng</a>
                ...
                <form action="OrderMana.php">
                    ...
                    $rs5 = mysqli_query($connect, "SELECT orders.Id_orders, orders.OrderDate FROM orders WHERE Id_account='$Id_account' order by orders.OrderDate desc");
                    if ($rs5->num_rows > 0) {
                            ...
                            <div class="order-mana-UI1">
                                <div class="order-mana-con">
                                    <div class="order-mana-con-status">
                                        <?php
                                        $rs9 = mysqli_query($connect, "SELECT * FROM orders where Id_orders='$Id_orders'");
                                        if ($rs9->num_rows > 0) {
                                    ...
                                    <div class="order-mana-con-product">
                                        <?php
                                        $user_name = $_SESSION['username'];
                                        $rs7 = mysqli_query($connect, "SELECT products.ProductImage, orders_detail.Price, products.ProductName,orders_detail.Quantity,( orders_detail.Quantity * orders_detail.Price ) As Total  
                                        FROM accounts, orders_detail,products, orders 
                                        WHERE orders.Id_orders=orders_detail.Id_orders 
                                        and accounts.Id_account=orders.Id_account 
                                        and products.Id_product=orders_detail.Id_product 
                                        and UserName='$user_name' 
                                        and orders_detail.Id_orders='$Id_orders' 
